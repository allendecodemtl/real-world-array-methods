...
// Use the appropriate array method to figure out, using the hourly data, whether there is going to be any rain in the next 24 hours. 
// The method you use should return true or false.

function anyRain(){
    
    var idx = weatherMsg.hourly.data.findIndex(function(item){
...
function anyRain2(){
    ...
    var temp = weatherMsg.hourly.data
                .filter(function(item){
                    return item.time < 1468015200; 
